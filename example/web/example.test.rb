...
class Klenod::ExampleTest < Minitest::Test
  ...
  def test_example_app_renders_docs_routes_with_scoped_components
    ...
    assert_includes(html_by_path.fetch("/docs/plugins/HamlPlugin"), "Haml Reference")
    assert_includes(html_by_path.fetch("/docs/plugins/HamlPlugin"), "Object references are a Klenod key convention")
    assert_includes(html_by_path.fetch("/docs/plugins/HamlPlugin"), "components/markdown/CodeBlock")
    assert_includes(html_by_path.fetch("/docs/plugins/HamlPlugin"), "<h2")
    assert_includes(html_by_path.fetch("/docs/plugins/HamlPlugin"), "<h3")
  ...
  def test_example_app_renders_swedish_localized_routes
    ...
    assert_includes(html, "Importerad som AVIF- och WebP-varianter")
