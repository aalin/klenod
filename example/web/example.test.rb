...
class Klenod::ExampleTest < Minitest::Test
  ...
  def test_example_app_renders_docs_routes_with_scoped_components
    ...
    assert_includes(html_by_path.fetch("/docs/plugins/HamlPlugin"), "Matching translation files are loaded")
    assert_includes(html_by_path.fetch("/docs/plugins/HamlPlugin"), "instance")
