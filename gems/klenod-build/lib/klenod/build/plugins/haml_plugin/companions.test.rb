...
class Klenod::Build::Plugins::HamlPlugin::CompanionsTest < Klenod::Build::Plugins::HamlPlugin::TestSupport
  def test_haml_records_companion_watched_patterns
    Dir.mktmpdir do |dir|
      ...
      plugin = haml_plugin
      context = context_for(dir, plugin:)
