    ...
    module Plugins
      module NodeModulesPlugin
        ...
        module PackageExports
          ...
          COMMONJS_CONDITIONS = ["require", "node"].freeze
          ...
          def resolve_matched_target(target, subpath, conditions, pattern_match)
          ...
          def conditions_unmet_error(target, subpath, conditions)
            ...
            if (available & COMMONJS_CONDITIONS).any?
              return Result.unresolved(
                :commonjs_only,
                "The package exports #{subpath.inspect} as CommonJS only. Klenod can only import ES modules."
              )
            end

            Result.unresolved(
              :conditions_unmet,
              "No export condition matched for #{subpath.inspect}. " \
