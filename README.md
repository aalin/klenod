...
- [`klenod-lsp`](gems/klenod-lsp): serves editor diagnostics, navigation, completion, quick fixes, references, symbols, and import-preserving renames for Haml modules and Ruby imports over the Language Server Protocol. Install it separately; the `klenod` meta gem does not depend on it.
