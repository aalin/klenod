...
- [`klenod-lsp`](gems/klenod-lsp): serves editor diagnostics, navigation, completion, and quick fixes for Haml modules and Ruby imports over the Language Server Protocol. Install it separately; the `klenod` meta gem does not depend on it.
