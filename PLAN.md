...
- [ ] Add a structural route tree API for layout composition.
- [ ] Represent real parallel route slots in the route tree.
- [ ] Parse intercepted route segments such as `(.)`, `(..)`, and `(...)`.
