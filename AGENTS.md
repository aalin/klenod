...
- `gems/klenod-test/`: framework-independent application-test orchestration, dependency-aware watch runs, and worker isolation. It depends on `klenod-build` but not on a test framework.
